...
class TaskTest extends PHPUnit_Framework_TestCase {
	...
	public function test_TaskRoot_getAsYaml_empty() {
		...
		//echo "\n".$root->getAsYaml();
		$expected = $parser->parse(file_get_contents(ROOT.'test/data/tasks/TaskRoot_empty.yml'));		
		$this->assertEquals($expected,$parser->parse($root->getAsYaml()));		
	}
	...
	public function test_TaskRoot_getAsYaml_notEmpty() {
		...
		$parser = new sfYamlParser();
		//echo "\n".$root->getAsYaml();
		$expected = $parser->parse(file_get_contents(ROOT.'test/data/tasks/TaskRoot_notEmpty.yml'));
		$this->assertEquals($expected,$parser->parse($root->getAsYaml()));		
	}
